...
public class MessageBroadcastEngine {
  ...
  public MessageBroadcastEngine() {
    broadcastExecutor = new ThreadPoolExecutor(corePoolSize, maximumPoolSize, 100, TimeUnit.SECONDS,
        new LinkedBlockingQueue<Runnable>());
  }


  /**
   * Broadcast a message asynchronously. We use thread pool to run the threads responsible for
   * publishing messages.
   *
